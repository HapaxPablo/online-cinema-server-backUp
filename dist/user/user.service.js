...
const updateUser_dto_1 = require("../auth/dto/updateUser.dto");
...
let UserService = class UserService {
    ...
    async toggleFavorite(moveId, user) {
        const { _id, favorites } = user;
        await this.UserModel.findByIdAndUpdate(_id, {
            favorites: favorites.includes(moveId)
                ? favorites.filter((id) => String(id) != String(moveId))
                : [...favorites, moveId],
        });
    }
